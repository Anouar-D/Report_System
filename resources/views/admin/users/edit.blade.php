        ...
        <form action="{{ route('admin.user.update', $user->id) }}" method="post" class="card-body">
            ...
            <div class="container">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="last_name" type="text" class="@error('last_name') is-invalid @enderror form-control" name="last_name" value="{{ $user->last_name }}">
                        @error('last_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="email" type="text" class="@error('email') is-invalid @enderror form-control" name="email" value="{{ $user->email }}">
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="is_admin" type="checkbox" class="@error('is_admin') is-invalid @enderror form-control" name="is_admin" @if($user->is_admin) checked @endif>
                        @error('is_admin')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                {{-- <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="is_active" type="checkbox" class="@error('is_active') is-invalid @enderror form-control" name="is_active" @if($user->is_active) checked @endif>
                        @error('is_active')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
